						...
						<table width="100%">
							<tr width="100%">
								...
								<td width="40%" align="right"><a
									...
									class="breadcrumb-elements-item"> <button type="button" class="btn blue_btn">New Project</button>
								</a></td>
							</tr>
						</table>
					</div>
						...
						<table
							...
							<thead>
								<tr class="bg-blue">
									...
									<th width="10%" class="text-center">Project Desc </th>
									<th class="text-center">Project Link</th>

									<th class="text-center">Project Type</th>
									<th class="8%">Git Link</th>
									<th class="10%">Admin Username</th>
									<th class="10%">DB Ip</th>
									<th class="10%">DB Username</th>
									<th width="10%" class="10%">DB  Password</th>
									<th class="10%">DB Name </th>
							...
							<tbody>
								...
								<c:forEach items="${projectList}" var="pro" varStatus="count">
									<tr>
										<td>${count.index+1}</td>
										<td>${pro.projectName}</td>
										<td>${pro.projectDesc}</td>
										<td>${pro.projectLink}</td>
										<td>${pro.projectType}</td>
										<td>${pro.gitLink}</td>
										<td>${pro.adminUsername}</td>
										<td>${pro.adminPass}</td>
										<td>${pro.databaseIp}</td>
										<td>${pro.dbUsername}</td>
										<td>${pro.dbPassword}</td>
										<td>${pro.status}</td>
										
										<td class="text-center"><a
											href="${pageContext.request.contextPath}/editProjectMst?projectId=${pro.projectId}"
											class="list-icons-item text-primary-600" data-popup="tooltip"
											title="" data-original-title="Edit"><i
												class="icon-pencil7"></i></a> <a
											href="${pageContext.request.contextPath}/deleteProjectMst?projectId=${pro.projectId}"
