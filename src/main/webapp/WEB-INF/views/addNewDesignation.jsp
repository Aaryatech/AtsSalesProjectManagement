					...
					<div class="col-md-12">
						...
						<div class="card">
								...
								<table width="100%">
									...
									<c:choose>
										...
										<td width="60%"><h5 class="pageTitle">
												<i class="icon-list-unordered"></i> EDIT DESIGNATION
											</h5></td>
										<td width="40%" align="right">
										</c:when>
										<c:otherwise>
										<td width="60%"><h5 class="pageTitle">
												<i class="icon-list-unordered"></i> ADD NEW DESIGNATION
											</h5></td>
										<td width="40%" align="right">
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/submitDesignationForm"
									class="form-validate-jquery" novalidate="novalidate"
									id="submitTagForm" method="post">

									
									<input type="hidden" id="desgId" value="${designation.mDesignationId}" name="desgId">
	
									<div class="form-group row">
										<div class="col-md-6">
											<label
												class="col-form-label text-info font-weight-bold col-lg-5 float"
												for="tagName">Designation Name<span class="text-danger">*
											</span>:
											</label>
											<div class="col-lg-7  float">
												<input type="text" class="form-control" value="${designation.mDesignationName}"
													placeholder="Enter Designation Name" id="desgName" name="desgName"
									...
									<div class="form-group row mb-0">
										<div style="margin: 0 auto;">
											...
											<a
												href="${pageContext.request.contextPath}/designationList"><button
