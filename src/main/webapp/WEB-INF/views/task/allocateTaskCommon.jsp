...
<h4 class="font-weight-semibold">Allocate Selected Task</h4>
...
<form class="form-validate-jquery"
	action="${pageContext.request.contextPath}/submitAllocateCommontask"
										...
										function(e) {
											...
											if (!isError) {
												...
												if (x == true) {
													...
													$
															.ajax({
																url : '${pageContext.request.contextPath}/submitAllocateCommontask',
																type : 'post',
																dataType : 'json',
																data : fd,
																contentType : false,
